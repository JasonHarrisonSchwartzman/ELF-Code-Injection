...
def add_functions_to_got(elf_object,file,offset,size,plt_sec_inject_offset,got_alignment_size):
    sizes = [8]
...
add_functions_to_got(elf,f,got_inject_offset,got_size,plt_sec_inject_offset,got_alignment_size)
